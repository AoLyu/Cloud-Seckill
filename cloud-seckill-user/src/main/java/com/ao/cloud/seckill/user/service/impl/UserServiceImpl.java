package com.ao.cloud.seckill.user.service.impl;
...
import com.ao.cloud.seckill.user.model.dao.UserDOMapper;
import com.ao.cloud.seckill.user.model.dao.UserPasswordDOMapper;
import com.ao.cloud.seckill.user.model.dataobject.UserDO;
...
//   用@Validate 去验证    2022/01/02
    ...
    public void register(UserModel userModel) {
        if(userModel == null){
            throw new CloudSekillException(CloudSeckillExceptionEnum.REQUEST_PARAM_ERROR);
        }
//        用@Validate 去验证 2022/01/02
        ...
        try{
            ...
            throw new CloudSekillException(CloudSeckillExceptionEnum.REQUEST_PARAM_ERROR.getCode(),"手机号已重复注册");
        }
    ...
    @Override
    public UserModel validateLogin(String telephone, String encrptPassword) throws CloudSekillException {
        //通过用户的手机获取用户信息
        ...
        if(!StringUtils.equals(encrptPassword,userModel.getEncrptPassword())){
            throw new CloudSekillException(CloudSeckillExceptionEnum.USER_LOGIN_FAIL);
        }
        return userModel;
    }
