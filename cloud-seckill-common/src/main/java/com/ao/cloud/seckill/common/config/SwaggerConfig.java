package com.ao.cloud.seckill.common.config;
...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = {"com.ao.cloud.seckill"}) // 扫描路径
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.ao.cloud.seckill"))
